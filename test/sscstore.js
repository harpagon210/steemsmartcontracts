...
describe('sscstore smart contract', () => {
  ...
  it('should buy tokens', (done) => {
    new Promise(async (resolve) => {
      ...
      let transactions = [];
      transactions.push(new Transaction(30529000, 'TXID1236', 'Satoshi', 'sscstore', 'buy', '{ "recipient": "rocketx", "amountSTEEMSBD": "0.001 STEEM", "isSignedWithActiveKey": true }'));
  ...
  it('should not buy tokens', (done) => {
    new Promise(async (resolve) => {
      ...
      transactions = [];
      transactions.push(new Transaction(30529000, 'TXID1237', 'rocketx', 'sscstore', 'updateParams', '{ "priceSBD": 0.001, "priceSteem": 0.001, "quantity": 1, "disabled": true }'));
      transactions.push(new Transaction(30529000, 'TXID1238', 'Satoshi', 'sscstore', 'buy', '{ "recipient": "rocketx", "amountSTEEMSBD": "0.001 STEEM", "isSignedWithActiveKey": true }'));
  ...
  it('should update params', (done) => {
    new Promise(async (resolve) => {
      ...
      let transactions = [];
      transactions.push(new Transaction(30529000, 'TXID1236', 'rocketx', 'sscstore', 'updateParams', '{ "priceSBD": 0.002, "priceSteem": 0.003, "quantity": 5, "disabled": true }'));
